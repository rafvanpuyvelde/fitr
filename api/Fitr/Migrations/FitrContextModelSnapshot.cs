...
{
    [DbContext(typeof(FitrContext))]
    partial class FitrContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fitr.Models.Set", b =>
                {
                    ...
                    b.Property<bool>("UsesBands")
                        .HasColumnType("bit");

                    b.Property<bool>("UsesChains")
                        .HasColumnType("bit");
                    ...
                    b.HasCheckConstraint("CK_Sets_Unit_Enum_Constraint", "[Unit] IN(0, 1)");
                });
            ...
            modelBuilder.Entity("Fitr.Models.WorkoutHasExercise", b =>
                {
                    b.Property<int>("WorkoutId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fitr.Models.Workout", b =>
                {
                    b.HasOne("Fitr.Models.User", "User")
                        .WithMany("Workouts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Fitr.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
